...
public class TGoodsController {
    ...
    public String toList(Map<String,Object> model){
        model.put("goodsList", goodsService.findGoodsVo());
    ...
    public String toListID(TUser user, @PathVariable @ApiParam(value = "商品ID",example = "1",required = true) Long id){
        ...
        return JSON.toJSONString(ResponseResult.ok(detailVo));
    }
